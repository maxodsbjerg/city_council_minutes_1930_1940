---
title: "city_council_minutes_1930-1940"
...
indlæs data
```{r}
minutes_1930_1940 <- read_csv("/home/max/workspace/city-council-minutes/data/city-council-minutes-1930-1940.csv")
```
